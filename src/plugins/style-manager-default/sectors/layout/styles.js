      ...
      defaults: () => ({
        ...
        list: [
          ...
          },
          {
            ...
            value: 'full-width',
            name:
              '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#000" fill-rule="evenodd" d="M2 6v12h6V6H2zm0 13v5H1V0h1v5h6c.6 0 1 .4 1 1v12c0 .6-.4 1-1 1H2zM16 6v12h6V6h-6zm6-1V0h1v24h-1v-5h-6a1 1 0 01-1-1V6c0-.6.4-1 1-1h6z"></path></svg>'
          }
        ]
      })
    }),
    view: propView.extend({
      ...
      getCoords(elem, children) {
        ...
        return {
          ...
          bottom:
            elem.clientHeight - children.clientHeight - padding.top + 'px',
          center:
            elem.clientWidth / 2 -
      ...
      updatePosition(x, y) {
        ...
        leftProp.set('value', x ? x : 0)
        topProp.set('value', y ? y : 0)
      },
      handleAlignment(action) {
        const box = editor.getSelected()
        ...
        switch (action) {
          ...
          case 'full-width':
            this.updatePosition(left, currentTop)
            box.addStyle({ width: '100%', 'max-width': '100%' })
            break
        }
